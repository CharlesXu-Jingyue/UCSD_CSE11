...
class ExampleTweets {
    ...
    void testcountPopularTweets(Tester t) {
        t.checkExpect(this.tweet1.countPopularTweets(10000), 1);
        t.checkExpect(this.tweet2.countPopularTweets(100), 1);
        t.checkExpect(this.tweet3.countPopularTweets(20), 3);
        t.checkExpect(this.tweet5.countPopularTweets(0), 4);
    }
    */
}